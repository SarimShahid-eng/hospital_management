            ...
            <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
                <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                    <div class="w-lg-500px p-10">
                        <div class="text-center mb-11 d-flex justify-content-center align-items-center">
                            <h1 class="text-gray-900 fw-bolder p-0 m-0">
                        ...
                        <form action="{{ route('receptionist.login') }}" method="POST">
                            @csrf
                    ...
                    <div class="d-flex flex-column flex-center px-5 px-md-15 w-100">
                        ...
                        <div>
                            <h1 id="clinic-title" class="d-none d-lg-block text-white fs-2qx fw-bolder text-center mb-0"
                                ...
                                <img class="image" src="{{ asset('assets') }}/logos/mks_updated_logo.png"
                                    alt="">
                                MKS CARDIOLOGY CLINIC
                            </h1>
                            <div class="d-flex justify-content-center" style="margin:30px 0;">
                                <img id="logo" alt="Logo" src="{{ asset('assets') }}/logos/Hsp.gif"
                                    class="d-none"
