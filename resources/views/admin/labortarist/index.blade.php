    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content  flex-column-fluid ">
            ...
            <div id="kt_app_content_container" class="app-container  container-xxl ">
                <!--begin::Form-->
                    <form class="imageUploadForm" enctype="multipart/form-data" method="POST" action="@adminRoute('labortarist.store')">
                        @csrf
                                                    ...
                                                    <select name="branch_id" class="form-select mb-2" data-control="select2"
                                                        ...
                                                        @foreach ($branches as $branch)
                                                            <option value="{{ $branch->id }}"
                                                                {{ @$branch->id == @$id->branch_id ? 'selected' : '' }}>{{ $branch->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @else
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <div class="d-flex flex-column flex-md-row gap-5">
                                                    ...
                                                    <div class="flex-row-fluid">
                                                        ...
                                                        <input class="form-control" name="username"
                                                            value="{{ @$id->username }}" placeholder="Enter Username">
                                                        <!--end::Input-->
                                                    </div>
                                                </div>
                                                <div class="d-flex flex-column flex-md-row gap-5">
                                                    <div class="flex-row-fluid col-md-3  col-lg-3 col-12" style="padding-left: 11px">
                                                        <label class="form-label w-100">Gender</label>
                                                        <div class="d-flex align-items-center gap-5">
                                                            <div class="form-check form-check-custom form-check-solid">
                                                                <input @checked(@$id->gender=='male') class="form-check-input" name="gender" type="radio" value="male" checked="" id="flexRadioMale" data-parsley-multiple="gender">
                                                                <label class="form-check-label" for="flexRadioMale">
                                                                    Male
                                                                </label>
                                                            </div>
                                                            <div class="form-check form-check-custom form-check-solid">
                                                                <input @checked(@$id->gender=='female') class="form-check-input" name="gender" type="radio" value="female" id="flexRadioFemale" data-parsley-multiple="gender">
                                                ...
                                                <div class="d-flex flex-column flex-md-row gap-5 col-lg-6 col-md-6 col-12">
                                                    <div class="fv-row flex-row-fluid fv-plugins-icon-container">
                                                        ...
                                                        @if ( @$id->image)
                                                        <img class="img-fluid mt-4 rounded-1" src="{{ asset('images')}}/Labortarist_profile/{{$id->image}}" alt="">
