                ...
                <div class="card mb-5 mb-xl-10">
                    <div class="card-body pt-9 pb-0">
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                            ...
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2">
                                <a class="nav-link  ms-0 me-10 py-5 active"
                                    href="{{ route(admin_route('profile.edit_profile')) }}">
                                    Settings </a>
                            </li>
                            <!--end::Nav item-->
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="fs-6 fw-semibold text-gray-500">Keep eye on on your Repositories
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-end">
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="fs-6 fw-semibold text-gray-500">Integrate Projects Discussions
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <tbody class="fs-6 fw-semibold">
                                            ...
                                            <tr>
                                                ...
                                                <td class="w-125px">
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        <input class="form-check-input" type="checkbox" value=""
                                                            id="kt_settings_notification_email" checked
                                                            data-kt-check="true"
                                                ...
                                                <td class="w-125px">
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        <input class="form-check-input" type="checkbox" value=""
                                                            id="kt_settings_notification_phone" checked
                                                            data-kt-check="true"
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1 ">
                                        ...
                                        <div class=" fw-semibold">
                                            ...
                                            <div class="fs-6 text-gray-700 ">For extra security, this requires you to
                                                ...
                                                <br /><a class="fw-bold" href="#">Learn more</a>
                                            </div>
                                        </div>
                                        <!--end::Content-->
