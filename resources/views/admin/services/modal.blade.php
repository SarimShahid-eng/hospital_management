                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                        ...
                        <div class="fv-row mb-7">
                            <label class="required fs-6 fw-semibold mb-2">Service name
                            </label>
                            <input type="text" id="service_name" name="name"
                                class="form-control form-control-solid" placeholder="Service name" value="" />
                        ...
                        <div class="fv-row mb-15">
                            ...
                            <br>
                            <select name="branch_id" id="branch" class="form-select mb-2" data-control="select2"
