                        ...
                        <div class="col-sm-6 col-xl-3 mb-xl-10">
                            <div class="card h-lg-100">
                                ...
                                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                    <div class="m-0">
                                        <i class="fa fa-user fa-2x text-gray-600">
                                            <span class="path1"></span><span class="path2"></span></i>
                                    </div>
                                    <!--end::Icon-->
                                    <div class="d-flex flex-column my-7">
                                        <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $patients ?? '0' }}</span>
                                        <div class="m-0">
                        ...
                        <div class="col-sm-6 col-xl-3 mb-xl-10">
                            <div class="card h-lg-100">
                                ...
                                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                    ...
                                    <!--end::Icon-->
                                    <div class="d-flex flex-column my-7">
                                        <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $admins ?? '0' }}</span>
                                        <div class="m-0">
                                            <span class="fw-semibold fs-6 text-gray-500">
                                                Admins </span>
                        ...
                        <div class="col-sm-6 col-xl-3 mb-xl-10">
                            ...
                            <div class="card h-lg-100">
                                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                    <!--begin::Icon-->
                                    <div class="m-0">
                                        <i class="fa-solid fa-user-doctor fa-2x text-gray-600">
                                            <span class="path1"></span><span class="path2"></span></i>

                                    </div>
                                    <!--end::Icon-->
                                    <div class="d-flex flex-column my-7">
                                        <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $doctors ?? '0' }}</span>
                                        <div class="m-0">
                                            <span class="fw-semibold fs-6 text-gray-500">
                                                Doctors </span>
                                        </div>
                            ...
                            <div class="card h-lg-100">
                                ...
                                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                    ...
                                    <div class="d-flex flex-column my-7">
                                        <!--begin::Number-->
                                        <span
                                            class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $receptionist ?? '0' }}</span>
                                        <div class="m-0">
                                            <span class="fw-semibold fs-6 text-gray-500">
                                                Receptionist</span>
