                ...
                <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                    ...
                    <div class="w-lg-500px p-10">
                        ...
                        <form class="form w-100" novalidate="novalidate"
                            method="POST" action="{{ route('labortarist.login') }}">
                            @csrf
                            <!--begin::Heading-->
                            ...
                            <div class="row g-3 mb-9">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="#" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
                                        ...
                                        <i class="fa-solid fa-user"></i>  Labortary-Sign in
                                    </a>
                                    <!--end::Google link--->
                                </div>
                                <!--end::Col-->
                            ...
                            <div class="fv-row mb-8">
                                <!--begin::Email-->
                                <input type="text" :value="old('username')" required  placeholder="Email" name="username" autocomplete="off"
...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo1/authentication/layouts/corporate/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Apr 2024 09:45:07 GMT -->
