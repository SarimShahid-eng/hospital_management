@extends('admin.pagelayouts.index')
@section('content')
                ...
                <div class="col-sm-6 col-xl-2 mb-xl-10">
                    ...
                    <div class="card h-lg-100">
                        ...
                        <div
                            ...
                            <!--begin::Icon-->
                            <div class="m-0">
                                <i class="fa fa-compass fa-2x text-gray-600">
                                <span
                    ...
                    <div class="card h-lg-100">
                        ...
                        <div
                            ...
                            <div class="d-flex flex-column my-7">
                                <!--begin::Number-->
                                <span
                                    class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">27,5M</span>
                                <!--end::Number-->
                ...
                <div class="col-sm-6 col-xl-2 mb-xl-10">
                    ...
                    <div class="card h-lg-100">
                        ...
                        <div
                            ...
                            <!--begin::Icon-->
                            <div class="m-0">
                                <i class="fa fa-search fa-2x text-gray-600">
                                <span
                                        class="path1"></span><span class="path2"></span></i>
                ...
                <div class="col-sm-6 col-xl-2 mb-xl-10">
                    ...
                    <div class="card h-lg-100">
                        ...
                        <div
                            ...
                            <!--begin::Icon-->
                            <div class="m-0">
                                <i class="fa fa-map fa-2x text-gray-600">
                                <span
                                        class="path1"></span><span class="path2"></span><span
                                        class="path3"></span></i>
                ...
                <div class="col-sm-6 col-xl-2 mb-5 mb-xl-10">
                    ...
                    <div class="card h-lg-100">
                        ...
                        <div
                            ...
                            <!--begin::Icon-->
                            <div class="m-0">
                                <i class="fa fa-cog fa-2x text-gray-600">
                                <span
                                        class="path1"></span><span class="path2"></span></i>
                            ...
                            <div class="d-flex flex-column my-7">
                                <!--begin::Number-->
                                <span
                                    class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">72.4%</span>
                                <!--end::Number-->
                ...
                <div class="col-sm-6 col-xl-2 mb-5 mb-xl-10">
                    ...
                    <div class="card h-lg-100">
                        ...
                        <div
                            ...
                            <!--begin::Icon-->
                            <div class="m-0">
                                <i class="fa fa-check-square fa-2x text-gray-600">
                                <span
                                        class="path1"></span><span class="path2"></span></i>
                    ...
                    <div class="card card-flush h-100 mb-5 mb-xl-10">
                        ...
                        <div class="card-header pt-7">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-gray-900">Leading
                                    Companies</span>

                                <span class="text-gray-500 pt-2 fw-semibold fs-6">8k social
                                    visitors</span>
                            </h3>
                            <!--end::Title-->
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade show active"
                                    ...
                                    <div id="kt_charts_widget_19_chart_1"
                                        class="w-100 h-400px mb-13 mt-n4"></div>
                                    <!--end::Chart container-->
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="d-flex flex-stack">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <!--begin::Number-->
                                                <span
                                                    class="text-gray-800 fw-bold fs-4 me-3">579</span>
                                                <!--end::Number-->
                ...
                <div class="col-xl-8 mb-xl-10">
                    ...
                    <div class="card card-flush h-xl-50 mb-5 mb-xl-10">
                        ...
                        <div class="card-header pt-7">
                            <!--begin::Title-->
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-gray-800">LOI Issued by
                                    Departments</span>
                                <span class="text-gray-500 mt-1 fw-semibold fs-6">Counted in
                                    Millions</span>
                            </h3>
                            <!--end::Title-->
                            ...
                            <div class="card-toolbar">
                                ...
                                <div data-kt-daterangepicker="true"
                                    ...
                                    <i class="fa fa-calendar fa-2x text-gray-500 lh-0 ms-2 me-0">
                                    <span
                                            class="path1"></span><span class="path2"></span><span
                        ...
                        <div
                            ...
                            <div class="d-flex flex-wrap d-grid gap-5 px-9 mb-5">
                                ...
                                <div class="me-md-2">
                                    ...
                                    <!--begin::Description-->
                                    <span class="fs-6 fw-semibold text-gray-500">Targets for
                                        April</span>
                                    <!--end::Description-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div
                                    ...
                                    <!--begin::Description-->
                                    <span class="fs-6 fw-semibold text-gray-500">Actual for
                                        April</span>
                                    <!--end::Description-->
                                </div>
                                <!--end::Item-->
                        ...
                        <div class="card-body d-flex flex-column flex-center">
                            ...
                            <div class="text-center mb-1">
                                ...
                                <a class="btn btn-sm btn-primary me-2"
                                    data-bs-target="#kt_modal_new_address" data-bs-toggle="modal">
                                    Try Now </a>
                                <!--end::Link-->
                ...
                <div class="col-xxl-8">
                    ...
                    <div class="card card-flush overflow-hidden h-md-100">
                        ...
                        <div class="card-header py-5">
                            <!--begin::Title-->
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-gray-900">Some Chart with
                                    AmCharts</span>
                                <span class="text-gray-500 mt-1 fw-semibold fs-6">83 countries in
                                    service</span>
                            </h3>
                            <!--end::Title-->
            ...
            <div class="row g-5 g-xl-10">
                ...
                <div class="col-xxl-4">
                    ...
                    <div class="card card-flush h-md-100">
                        ...
                        <div class="card-header pt-7">
                            <!--begin::Title-->
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-gray-900">Warephase
                                    stats</span>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="kt_chart_widget_25_tab_content_1">
                                    <!--begin::Chart-->
                                    <div id="kt_charts_widget_25_chart_1" class="w-100 h-400px">
                                    </div>
                                    <!--end::Chart-->
                                </div>
                                <!--end::Tap pane-->
                                ...
                                <div class="tab-pane fade active show"
                                    id="kt_chart_widget_25_tab_content_2">
                                    <!--begin::Chart-->
                                    <div id="kt_charts_widget_25_chart_2" class="w-100 h-400px">
                                    </div>
                                    <!--end::Chart-->
                                </div>
                                <!--end::Tap pane-->
                ...
                <div class="col-xxl-8">
                    ...
                    <div class="card card-flush overflow-hidden h-md-100">
                        ...
                        <div class="card-body pt-0">
                            <!--begin::Chart-->
                            <div id="kt_charts_widget_24" class="min-h-auto" style="height: 400px">
                            </div>
                            <!--end::Chart-->
                        </div>
                        <!--end::Card body-->
